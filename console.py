...
pet1 = Pet('Sid', '05/06/2013', 'Cat', 'Kay Hunter', '02346 789 908', vet1, 'old and heavy', 'image')
pet_repository.save(pet1)
pet2 = Pet('Skye', '017/09/2019', 'Dog', 'John Hill', '02346 544 726', vet2, 'No major issues', '/images/vera.jpg')
pet_repository.save(pet2)
pet3 = Pet('Finn', '04/01/2022', 'Beast', 'Carol Hill', '02346 544 726', vet2, 'Hip transplant', '/images/vera.jpg')
